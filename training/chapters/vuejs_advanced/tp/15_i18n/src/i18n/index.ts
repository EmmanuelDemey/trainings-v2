 ...
 * instance per app.
 *
 * TODO 1.1: `fallbackLocale: 'en'`, so a key missing from a catalogue falls back
 *   instead of rendering as itself.
 *
 * TODO 1.2: `numberFormats` — name the formats here, once, instead of inlining
 ...
 *
 * TODO 1.3: `pluralRules` for `fr`. vue-i18n's default rule is **English grammar,
