...
# Annexe — Transition & TransitionGroup
...
- `:name` is **dynamic**: `<Transition :name="direction">` is how per-route
  slide transitions are built (chapter 6)
...
- Route transitions are covered in **chapter 6**, together with the native
...
```ts
// Chapter 3: by default, @vue/test-utils stubs <Transition>
...
## Workshop 10 - Transition & TransitionGroup — 45 min
