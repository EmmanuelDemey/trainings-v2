...
# Annexe — Anatomy of a Vue plugin
...
- ⚠️ Don't confuse the two plugin systems: a **Pinia plugin** (`pinia.use`, chapter 9)
...
## Workshop 4 - From directives to a real plugin — 30 min
