...
<div style="opacity:.7; font-size:.85em">📁 <code>chapters/javascript/tp/09_countdown/</code></div>
...
<div style="opacity:.7; font-size:.85em">📁 <code>chapters/javascript/tp/10_password_generator/</code></div>
...
<div style="opacity:.7; font-size:.85em">📁 <code>chapters/javascript/tp/11_staff_directory/</code></div>
...
<div style="opacity:.7; font-size:.85em">📁 <code>chapters/javascript/tp/12_social_network/</code></div>
...
|---------|--------------------|----------------|
| `fetch` and promises | Needs the async model — half a day on its own | **optional module** — chapter 10 |
| ES modules | Needs a server, changes the tooling | **optional module** — chapter 11 |
| `localStorage` | Ten minutes, once the state pattern is solid | **optional module** — chapter 12 |
