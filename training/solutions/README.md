...
One folder per workshop, mirroring `chapters/node/tp/` and
`chapters/vuejs_advanced/tp/`. Each folder is a **complete, runnable copy** of
the starter with every `// TODO` implemented: `npm install` and it runs.
