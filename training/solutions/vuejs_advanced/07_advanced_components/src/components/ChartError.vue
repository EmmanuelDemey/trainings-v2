 ...
 *
 * Note: `defineAsyncComponent` does not wire a retry button for you. Here we
 * simply reload the page, which is also the right move when the failure comes
 * from a stale chunk after a new deployment.
 */
